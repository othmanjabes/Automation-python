...
FROM =  'othman-jabes@hotmail.com' # "your from email id"
TO = 'otman.jabes@gmail.com' # "your to email ids"  # can be a list
PASS = 'rorny2-qysmaz-Zugrif' # "your email id's password"
